...
import "../client/node_modules/@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";   //With this, we can keep track of how many NFTs there are, and who posses them
...
contract CryptoCoders is ERC721, ERC721Enumerable{
    ...
    function mint(string memory coder) public {
        require(!_coderExists[coder], "Coder already exists..");
        coders.push(coder);
